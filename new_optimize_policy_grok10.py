...
class PolicyOptimizer:
    ...
    def gradient_descent_batch(self, elites, learning_rate=0.1):
        gradients, base_fitness, perturbed_plus_batch, fitness_plus, perturbed_minus_batch, fitness_minus = self.compute_gradient_batch(elites)
        improved_elites = []
